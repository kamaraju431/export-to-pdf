			...
			<nav class="navbar navbar-inverse bs-dark">
				<div class="navbar-header">
					...
					<a class="navbar-brand" style="color: #ffffff"
						href="http://aizant.com/">AIZANT SAMPLE TRACKING</a>
				</div>

				<div class="collapse navbar-collapse"
					id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav" width="100px">
						<li><a href="/Sample/display_study" style="color: #ffffff"
							target="_self">HOME</a></li>

						<li class="dropdown"><a href="#" class="dropdown-toggle"
							style="color: #ffffff" data-toggle="dropdown" role="button"
							aria-haspopup="true" aria-expanded="false">WHY WE <span
								class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="http://aizant.com/current-jobs.html">CAREERS</a></li>
								<li><a href="http://aizant.com/news.html">NEWS</a></li>
								<li><a href="http://aizant.com/contact-us.html">CONTACT
										US</a></li>
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown"><a href="#"
							class="dropdown-toggle navbar-img" style="color: #ffffff"
							data-toggle="dropdown" role="button" aria-haspopup="true"
							aria-expanded="false"><%=session.getAttribute("loggedInUser")%>
